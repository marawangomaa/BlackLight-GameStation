...
import { LayoutDashboard, Calendar, ShoppingCart, Box, Truck, User, ShieldAlert, Globe, Activity, UserCircle, Home, LogIn, LogOut, Database, Megaphone } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, lang, setLang, role, isGuest, onLoginRequest, onLogout }) => {
  const isAr = lang === 'ar';
  ...
  return (
    <div className={`fixed inset-y-0 ${isAr ? 'right-0' : 'left-0'} w-64 bg-zinc-950 border-${isAr ? 'l' : 'r'} border-zinc-800 flex flex-col z-50`}>
      <div className="p-6">
